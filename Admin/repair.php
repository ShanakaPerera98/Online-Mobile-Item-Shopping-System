...
<?php require_once('repair_delete.php');?>
<!doctype html>
<html lang="en">
  <head>
  ...
  <body>
    ...
    <!-- Nav Bar --------------------------------------------------------------------------------->
      <div class="container1">
        ...
        <!-- Repair Table --------------------------------------------------------->
        <div class="container">
            <div class="row col-md col-md-offset-2 custyle">
            <table class="table table-striped custab">
            <thead>
            <a href="addrepair.php" class="btn btn-primary btn-xs text-right"><b>+</b> Add repair item details</a>
            
            <!-- <div class="input-group">
              <div class="form-outline">
                <input type="search" id="form1" class="form-control" placeholder="Search repair ID" />
              </div>
            ...
            <?php 
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['re_cname']; ?></td>
                        <td><?php echo $row['re_email']; ?></td>
                        <td><?php echo $row['re_iname']; ?></td>
                        <td style="color: #14751c;"><?php echo $row['re_status']; ?></td>
                        <td><span>Rs. </span><?php echo $row['re_price']; ?></td>
                        <td class="text-center">
                      <form action="" method="post">
                      <a class='btn-edit' href="addrepair_edit.php?re_id=<?php echo $row['re_id']; ?>"><i class="fa fa-edit"></i></a>
                    <input type="hidden" name="reid" value="<?php echo $row['re_id']; ?>">
                    <button class="btn-delete" name="delete" onclick="return confirm('Are you sure to Remove your Item?')"><i class="fas fa-trash"></i></button>
                    </form>
