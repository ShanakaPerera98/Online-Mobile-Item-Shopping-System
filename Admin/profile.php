  ...
  <body>
    ...
    <div class="login-popup-wrap new_login_popup">
      ...
      <form action="" method="post">
          <h6 class="topic2">Change Password</h6>
                <div class="col-lg-6">
                    <div class="form-group">
                    <input type="password" class="form-control" id="password" placeholder="Current Password" name="cupass"></div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                    <input type="password" class="form-control" id="password" placeholder="New Password" name="npass"></div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                    <input type="password" class="form-control" id="password" placeholder="Confirm Password" name="cpass"></div>
                </div>
      <button type="submit" class="regisnbtn" name="submit">Save Changes</button>
      </form>
      <br>
  </div>
