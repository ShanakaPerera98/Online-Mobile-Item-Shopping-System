            ...
            <div class="container1">
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="item_id" name="i_code">
                      </div>
                    <div class="form-group">
                    ...
                    <label class="subtopic" for="color">Select Colors</label>
                    ...
                    while($row = mysqli_fetch_array($result)){?>
                        ...
                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="color[]" value="<?php echo $row['color_name']; ?>">
                        <label class="form-check-label" for="color"><?php echo $row['color_name']; ?></label>
                        <?php } ?>
                      </div>
                      <br>
                    ...
                    <div class="form-group">
                        <label class="subtopic">Main Category</label>
                        <select class="form-control" id="exampleFormControlSelect1" name="mcategory">
                        <?php
                require_once('connection.php');
                ...
                <?php } ?>
                    ...
                    <div class="form-group">
                      ...
                      <a class="btn btn-primary1" href="../item.php">Back</a>
