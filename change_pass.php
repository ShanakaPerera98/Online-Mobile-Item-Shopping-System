    ...
    <div class="login-popup-wrap new_login_popup">
      ...
      <form action="" method="post">
          ...
          <div class="form-group">
              <input type="password" class="form-control" id="password" placeholder="Current Password" name="current"></div>

              <div class="form-group">
              <input type="password" class="form-control" id="password" placeholder="Enter New Password" name="npass"></div>
      ...
      <button type="submit" class="rebtn" name="update">Save</button>
      </form>
      <br>
  </div>
